...
def render_cruzamento_inteligente_v2():
    ...
    def _build_totalizador(df_result, compare_meta, totalizador_cols):
        ...
        rows = []
        grouped = work.groupby(group_labels, dropna=False)
        ...
        # Mantém linhas com movimento relevante no resumo.
    ...
    st.download_button(
        ...
        data=excel_bytes,
        file_name=f"Match_Inteligente_V13_{datetime.now().strftime('%Y%m%d_%H%M')}.xlsx",
