...
def render_cruzamento_inteligente_v2():
    ...
    if "v13_group_choices" in st.session_state:
        st.session_state["v13_group_choices"] = [x for x in st.session_state["v13_group_choices"] if x in group_options]
    ...
    if "v13_value_choices" in st.session_state:
        st.session_state["v13_value_choices"] = [x for x in st.session_state["v13_value_choices"] if x in compare_value_options]
